...
<body>
  ...
  <script>
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Post("/auth/email/send-otp", authHandler.SendEmailOTP)
		r.Post("/auth/email/register", authHandler.RegisterWithEmail)
		r.Post("/auth/email/login", authHandler.LoginWithEmail)
